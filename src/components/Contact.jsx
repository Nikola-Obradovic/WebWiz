 ...
 const [loading, setLoading] = useState(false);
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Aldin Zelihić",
          from_email: form.email,
          to_email: "wincomebih@gmail.com",
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Javite se</p>
        ...
        >
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Vaše ime</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Vaš email</span>
            <input
              type="email"
              name="email"
              value={form.email}
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Poruka</span>
            <textarea
              rows={7}
              name="message"
              value={form.message}
